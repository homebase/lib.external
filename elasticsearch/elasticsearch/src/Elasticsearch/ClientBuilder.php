...
class ClientBuilder
{
     ...
     */
    public function setSSLCert(string $cert, string|null $password = null): ClientBuilder
    {
     ...
     */
    public function setSSLKey(string $key, string|null $password = null): ClientBuilder
    {
