...
class Connection implements ConnectionInterface
{
     ...
     * @return mixed
     */
    public function performRequest(string $method, string $uri, ?array $params = [], $body = null, array $options = [], Transport|null $transport = null)
    {
        if ($body !== null) {
    ...
    {
        return function (array $request, Connection $connection, Transport|null $transport = null, $options = null) use ($handler) {
